			...
			<div class="ny-left">
				...
				<div class="ny-left-content">
					<ul>
						...
						<li class="cur"><a href="<c:url value='/jxyjgg/jxggcg.jsp'/>">教学改革成果</a><ul></ul></li>
			...
			<div class="ny-right">
				<div class="ny-right-title">
					当前位置：<a href="<c:url value='/index.jsp'/>">首页</a>&nbsp;&gt;&gt;&nbsp;<a
						...
						href="<c:url value='/jxyjgg/jxggcg.jsp'/>">教学改革成果</a>
				</div>
				<div class="ny-right-content news-list01">
					<ul>
						<li><a href="#">2012-2014年法学教师教改论文</a><span class="fRight">2017-05-03</span></li>
						<li><a href="#">2012-2014年法学教师教改论文</a><span
							class="fRight">2016-11-25</span></li>
					</ul>
					<div class="clear"></div>
