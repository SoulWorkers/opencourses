		...
		<div class="content ny-content">
			<div class="ny-left">
				...
				<div class="ny-left-content">
					<ul>
						<li class="cur"><a href="<c:url value='/jxyjgg/jxggcs.jsp'/>">教学改革措施</a><ul></ul></li>
			...
			<div class="ny-right">
				<div class="ny-right-title">
					当前位置：<a href="<c:url value='/index.jsp'/>">首页</a>&nbsp;&gt;&gt;&nbsp;<a
						...
						href="<c:url value='/jxyjgg/jxggcs.jsp'/>">教学改革措施</a>
				</div>
				<div class="ny-right-content">
					<div class="right-main-show">
						<span style="font-family:宋体;font-size:10.5pt;">教学改革措施</span>
					</div>
				</div>
