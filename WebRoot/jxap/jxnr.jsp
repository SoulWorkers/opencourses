...
<div class="content ny-content">
  ...
  <div class="ny-left">
    ...
    <div class="ny-left-content">
      <ul>
        <li class="cur" id="cur"><a href="<c:url value='/jxap/jxnr.jsp'/>">教学内容</a><ul></ul></li>
        ...
        <li class="" id=""><a href="<c:url value='/jxap/jxffysd.jsp'/>">教学方法与手段</a><ul></ul></li>
      </ul>
    </div>
  ...
  <div class="ny-right">
    <div class="ny-right-title"> 当前位置：<a href="<c:url value='/index.jsp'/>">首页</a>&nbsp;&gt;&gt;&nbsp;<a href="<c:url value='/jxap/index.jsp'/>">教学安排</a>&nbsp;&gt;&gt;&nbsp;<a href="<c:url value='/jxap/jxnr.jsp'/>">教学内容</a> </div>
    <div class="ny-right-content news-list01">
      <ul>
        <li><a href="#">教学内容</a><span class="fRight">2016-10-29</span></li>
        <li><a href="#" >合同法学每章教学内容及重点难点</a><span class="fRight">2016-10-29</span></li>
      </ul>
      <div class="clear"> </div>
