...
<div class="content ny-content">
  ...
  <div class="ny-left">
    ...
    <div class="ny-left-content">
      <ul>
        ...
        <li class="cur" id="cur"><a href="<c:url value='/jxap/jxdg.jsp'/>">教学大纲</a><ul></ul></li>
  ...
  <div class="ny-right">
    <div class="ny-right-title"> 当前位置：<a href="<c:url value='/index.jsp'/>">首页</a>&nbsp;&gt;&gt;&nbsp;<a href="<c:url value='/jxap/index.jsp'/>">教学安排</a>&nbsp;&gt;&gt;&nbsp;<a href="<c:url value='/jxap/jxdg.jsp'/>">教学大纲</a> </div>
    <div class="ny-right-content news-list01">
      <ul>
        <li><a href="#">课程教学大纲</a><span class="fRight">2016-10-29</span></li>
        <li><a href="#" >课程教学大纲2</a><span class="fRight">2016-10-29</span></li>
      </ul>
      <div class="clear"> </div>
