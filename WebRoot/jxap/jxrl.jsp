...
<div class="content ny-content">
  ...
  <div class="ny-left">
    ...
    <div class="ny-left-content">
      <ul>
        ...
        <li class="cur" id="cur"><a href="<c:url value='/jxap/jxrl.jsp'/>">教学日历</a><ul></ul></li>
  ...
  <div class="ny-right">
    <div class="ny-right-title"> 当前位置：<a href="<c:url value='/index.jsp'/>">首页</a>&nbsp;&gt;&gt;&nbsp;<a href="<c:url value='/jxap/index.jsp'/>">教学安排</a>&nbsp;&gt;&gt;&nbsp;<a href="<c:url value='/jxap/jxrl.jsp'/>">教学日历</a> </div>
    <div class=ny-right-content>
            <div class=right-main-show><a href="#">教学日历2018秋</a><p>&nbsp; </p></div>
    </div>
