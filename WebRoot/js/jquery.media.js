...
$.fn.media.defaults = {
	...
	flvPlayer:	 siteUrl+'ckplayer/ckplayer.swf',
	mp3Player:	 siteUrl+'mediaplayer.swf',
    mp4Player:	 siteUrl+'ckplayer/ckplayer.swf',
...
function generate(el, opts, player) {
	...
	if (player == 'iframe') {
        ...
        if(isMobile){
            var a=['<video src="'+opts.flashvars.file.replace('%2F','/')+'" controls="controls">'];
            a.push('</video>');
        }else{
