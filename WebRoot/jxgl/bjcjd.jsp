...
<div class="content ny-content">
  ...
  <div class="ny-left">
    ...
    <div class="ny-left-content">
      <ul>
		...
		<li class="cur" id="cur"><a href="<c:url value='/jxgl/bjcjd.jsp'/>">班级成绩单</a><ul></ul></li>
  ...
  <div class="ny-right">
    <div class="ny-right-title"> 当前位置：<a href="#">首页</a>&nbsp;&gt;&gt;&nbsp;<a href="<c:url value='/jxgl/index.jsp'/>">教学管理</a>&nbsp;&gt;&gt;&nbsp;<a href="<c:url value='/jxgl/bjcjd.jsp'/>">班级成绩单</a></div>
    <div class="ny-right-content news-list01">
      <ul>
        <li><a href="#">暂无</a><span class="fRight">2018-09-03</span></li>
      </ul>
      <div class="clear"> </div>
