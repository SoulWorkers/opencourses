...
<div class="content ny-content">
  ...
  <div class="ny-left">
    ...
    <div class="ny-left-content">
      <ul>
        ...
        <li class="cur" id="cur"><a href="<c:url value='/jxzy/syrw.jsp'/>">实验任务</a><ul></ul></li>
  ...
  <div class="ny-right">
    <div class="ny-right-title"> 当前位置：<a href="<c:url value='/index.jsp'/>">首页</a>&nbsp;&gt;&gt;&nbsp;<a href="<c:url value='/jxzy/index.jsp'/>">教学资源</a>&nbsp;&gt;&gt;&nbsp;<a href="<c:url value='/jxzy/syrw.jsp'/>">实验任务</a> </div>
