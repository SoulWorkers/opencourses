...
<div class="content ny-content">
  ...
  <div class="ny-left">
    ...
    <div class="ny-left-content">
      <ul>
        ...
        <li class="cur" id="cur"><a href="<c:url value='/jxzy/alk.jsp'/>">案例库</a><ul></ul></li>
  ...
  <div class="ny-right">
    <div class="ny-right-title"> 当前位置：<a href="<c:url value='/index.jsp'/>">首页</a>&nbsp;&gt;&gt;&nbsp;<a href="<c:url value='/jxzy/index.jsp'/>">教学资源</a>&nbsp;&gt;&gt;&nbsp;<a href="<c:url value='/jxzy/alk.jsp'/>">案例库</a> </div>
    <div class="ny-right-content news-list01">
      <ul>
        <li><a href="#">实验环境</a><span class="fRight">2016-10-29</span></li>
        <li><a href="#" >实验系统代码</a><span class="fRight">2016-10-29</span></li>
        <li><a href="#" >实验安装操作手册</a><span class="fRight">2016-10-29</span></li>
      </ul>
      <div class="clear"> </div>
