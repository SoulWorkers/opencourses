...
<div class="content ny-content">
  ...
  <div class="ny-left">
    ...
    <div class="ny-left-content">
      <ul>
        <li class="cur" id="cur"><a href="<c:url value='/jxhd/wxq.jsp'/>">微信群</a><ul></ul></li>
  ...
  <div class="ny-right">
    <div class="ny-right-title"> 当前位置：<a href="<c:url value='/index.jsp'/>">首页</a>&nbsp;&gt;&gt;&nbsp;<a href="<c:url value='/jxhd/index.jsp'/>">教学互动</a>&nbsp;&gt;&gt;&nbsp;<a href="<c:url value='/jxhd/wxq.jsp'/>">微信群</a> </div>
    <div class="ny-right-content news-list01">
      <ul>
        <li><a href="#">微信群号</a><span class="fRight"></span></li>
      </ul>
      <img src="<c:url value='/images/WeChat.png'/>"  width="60%"/>
      <div class="clear"> </div>
