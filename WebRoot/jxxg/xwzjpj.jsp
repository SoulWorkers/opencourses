...
<div class="content ny-content">
  ...
  <div class="ny-left">
    ...
    <div class="ny-left-content">
      <ul>
        <li class="cur" id="cur"><a href="<c:url value='/jxxg/xwzjpj.jsp'/>">校外专家评价</a><ul></ul></li>
  ...
  <div class="ny-right">
    <div class="ny-right-title"> 当前位置：<a href="<c:url value='/index.jsp'/>">首页</a>&nbsp;&gt;&gt;&nbsp;<a href="<c:url value='/jxxg/index.jsp'/>">教学效果</a>&nbsp;&gt;&gt;&nbsp;<a href="<c:url value='/jxxg/xwzjpj.jsp'/>">校外专家评价</a> </div>
    <div class="ny-right-content news-list01">
      <ul>
        <li><a href="#">校外专家评价</a><span class="fRight">2018-10-29</span></li>
      </ul>
      <div class="clear"> </div>
